...
const Müşteri = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => navigate("/müşteri/panel"), 2000);
    } catch (err) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (
        ...
        toast.error("Giriş işlemi iptal edildi. Lütfen tekrar deneyin.");
      } else {
            ...
            <div className="space-y-8">
              <div className="space-y-2 flex items-center text-white">
                ...
                <div className="border-l-2">
                  <p className="mx-2">Müşteri paneli</p>
                </div>
              </div>
              <div className="space-y-4">
                <h1 className="text-4xl font-bold text-white leading-tight">
                  herkesşurada'da hemen Müşteri ol
                  <br />
                </h1>
